    ...
    if uploaded_file is not None:
        ...
        for e in columns:
            for f in Year :
                    ...
                    fig_1.add_trace(go.Scatter(x=data_100['Simulation'], y = data_100[e],
                                               mode='lines', name='Variable = ' + str(e) + ' / Year = ' + str(f)))
        ...
        for e in columns:
            for f in Year:
                    data_100 = Total_Pool_selection[Total_Pool_selection['Year'] == f]
                    fig_2.add_trace(go.Scatter(x=data_100['Simulation'], y=data_100[e],
                                               mode='lines', fill='tozeroy',
                                               name='Variable = ' + str(e) + ' / Year = ' + str(f)))
        ...
        for e in columns:
            for f in Year:
                    data_100 = Total_Pool_selection[Total_Pool_selection['Year'] == f]
                    fig_3.add_trace(go.Bar(x=data_100['Simulation'], y=data_100[e],
                                           name='Variable = ' + str(e) + ' / Year = ' + str(f)))
        st.plotly_chart(fig_3, use_container_width=True)
        fig_4 = go.Figure()
        for e in columns:
            for f in Year:
                data_100 = Total_Pool_selection[Total_Pool_selection['Year'] == f]
                fig_4.add_trace(go.Scatter(x=data_100['Simulation'], y = data_100[e],
                                               mode='lines', name='Variable = ' + str(e) + ' / Year = ' + str(f)))
                fig_4.add_trace(go.Bar(x=data_100['Simulation'], y=data_100[e],
                                           name='Variable = ' + str(e) + ' / Year = ' + str(f)))
